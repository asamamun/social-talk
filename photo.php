    ...
    <div class="container mt-4">
        <div class="photo-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0">John Doe's Photos</h4>
                <div>
                    <button class="btn btn-primary me-2"><i class="fas fa-plus me-2"></i>Upload Photo</button>
            ...
            <div class="photo-grid">
                ...
                <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=300&h=300&fit=crop" alt="Photo">
                <img src="https://images.unsplash.com/photo-1519681393784-d120267933ba?w=300&h=300&fit=crop" alt="Photo">
                <img src="https://images.unsplash.com/photo-1490730141103-6cac27aaab94?w=300&h=300&fit=crop" alt="Photo">
            </div>
        </div>
    </div>
